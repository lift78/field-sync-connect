...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-primary-foreground hover:scale-105 shadow-button hover:shadow-lg",
        destructive:
        ...
        success: "bg-gradient-success text-success-foreground hover:scale-105 shadow-button",
        mobile: "bg-gradient-primary text-primary-foreground hover:bg-primary-glow shadow-lg active:scale-95 min-h-[48px] rounded-xl font-semibold",
      },
      size: {
